    ...
    <div className={`flex flex-col h-full overflow-hidden ${className}`}>
      ...
      <div className="p-4 border-b border-white/20 flex-shrink-0 glass">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <span className="font-medium text-white truncate drop-shadow">{citation.source_title}</span>
        </div>
      </div>
        ...
        <div className="border-b border-white/20 flex-shrink-0">
          <Accordion type="single" value={accordionValue} onValueChange={setAccordionValue} collapsible>
            <AccordionItem value="guide" className="border-0">
              <AccordionTrigger 
                className="px-4 py-3 text-sm font-medium hover:no-underline hover:bg-white/20" 
                style={{ color: '#ffffff' }}
                chevronColor="#ffffff"
              >
              ...
              <AccordionContent className="px-4 pb-4">
                <div className="text-sm text-white/90 space-y-4">
                  <div>
                    <h4 className="font-medium mb-2 text-white drop-shadow">Summary</h4>
                  ...
                  {citation.source_type === 'website' && sourceUrl && (
                    <div>
                      <h4 className="font-medium mb-2 text-white drop-shadow">URL</h4>
                      <a 
                        href={sourceUrl} 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-white hover:text-white/80 hover:underline break-all text-sm"
                      >
                        {sourceUrl}
                      </a>
                    </div>
