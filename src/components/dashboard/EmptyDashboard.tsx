...
const EmptyDashboard = () => {
  ...
  return <div className="text-center py-16">
      <div className="mb-12 glass-card rounded-2xl p-8">
        ...
        <p className="text-lg text-white/80 max-w-2xl mx-auto">fasterthanturbolearn is an AI-powered research and writing assistant that works best with the sources you upload</p>
      </div>
